...
replace (
	...
	k8s.io/node-api => k8s.io/node-api v0.18.15
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.18.15
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.18.15
	k8s.io/sample-controller => k8s.io/sample-controller v0.18.15
)
